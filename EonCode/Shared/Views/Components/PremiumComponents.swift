...
// Modern, sophisticated UI elements with beautiful gradients and effects

// MARK: - Gradient Orb

/// Animated gradient orb for hero sections and loading states
...
struct PremiumButton: View {
    ...
    private var shadowColor: Color {
        switch style {
        case .primary: return Color(red: 0.83, green: 0.64, blue: 0.45).opacity(0.3)
...
struct FloatingActionButton: View {
    ...
    private var shadowColor: Color {
        switch style {
        case .primary: return Color(red: 0.83, green: 0.64, blue: 0.45).opacity(0.4)
    ...
    var body: some View {
        HStack(spacing: 12) {
            if let icon = icon {
                Image(systemName: icon)
                    .font(.system(size: 14))
                    .foregroundColor(isFocused ? Color(red: 0.83, green: 0.64, blue: 0.45) : Color.primary.opacity(0.4))
            }
...
struct PremiumBadge: View {
    ...
    enum BadgeStyle {
        ...
        var colors: (bg: Color, text: Color) {
            ...
            case .error: return (Color.red.opacity(0.15), Color.red)
            case .accent: return (Color(red: 0.83, green: 0.64, blue: 0.45).opacity(0.15), Color(red: 0.83, green: 0.64, blue: 0.45))
            }
        }
    }
...
struct LoadingDots: View {
    var count: Int = 3
    var size: CGFloat = 8
    var color: Color = Color(red: 0.83, green: 0.64, blue: 0.45)
        ...
        Button(action: {
            ...
            ZStack {
                Circle()
                    .fill(style == .primary ? 
                          LinearGradient(
                            colors: [Color(red: 0.83, green: 0.64, blue: 0.45), Color(red: 0.70, green: 0.50, blue: 0.30)],
                            startPoint: .topLeading,
                            endPoint: .bottomTrailing
                          ) :
        ...
        ZStack {
            ...
            case .gradient:
                Circle()
                    ...
                    .frame(width: size, height: size)
                    .shadow(color: Color(red: 0.83, green: 0.64, blue: 0.45).opacity(0.3), radius: 8, x: 0, y: 4)
